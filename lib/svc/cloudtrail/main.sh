# XXX: DO NOT USE, ACHIVED, NEED p6_ and real API
...
aws_cloudtrail_trail_iam() {
    ...
    local cloudwatch_logs_role_arn=$(aws_iam_role_create "$trail_full_path" "$assume_role_policy_document")
