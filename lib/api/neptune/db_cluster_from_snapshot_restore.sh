...
p6_aws_neptune_db_cluster_from_snapshot_restore() {
    ...
    p6_run_write_cmd aws neptune restore-db-cluster-from-snapshot --db-cluster-identifier $db_cluster_identifier --snapshot-identifier $snapshot_identifier --engine $engine "$@"
}