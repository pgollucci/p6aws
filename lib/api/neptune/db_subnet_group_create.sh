...
p6_aws_neptune_db_subnet_group_create() {
    ...
    p6_run_write_cmd aws neptune create-db-subnet-group --db-subnet-group-name $db_subnet_group_name --db-subnet-group-description $db_subnet_group_description --subnet-ids $subnet_ids "$@"
}