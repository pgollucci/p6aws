...
p6_aws_iotevents_detector_model_update() {
    ...
    p6_run_write_cmd aws iotevents update-detector-model --detector-model-name $detector_model_name --detector-model-definition $detector_model_definition --role-arn $role_arn "$@"
}