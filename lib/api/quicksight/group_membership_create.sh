...
p6_aws_quicksight_group_membership_create() {
    ...
    p6_run_write_cmd aws quicksight create-group-membership --member-name $member_name --group-name $group_name --aws-account-id $aws_account_id --namespace $namespace "$@"
}