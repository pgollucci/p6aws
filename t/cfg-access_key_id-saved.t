...
main() {
    ...
    p6_test_start "env/p6_aws_env_access_key_id_saved"
    (
	p6_aws_cfg_clear

        p6_test_run "p6_aws_env_access_key_id_saved val"
        p6_test_assert_run_ok "p6_aws_env_access_key_id_saved returns blank"
